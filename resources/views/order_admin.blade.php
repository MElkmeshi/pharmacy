                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td>
                                <a
                                    href="{{ route('order.action', ['order_id' => $order->id, 'button_name' => 'delivered']) }}"><button
                                        class="status Delivered">Delivered</button></a>
                                <a
                                    href="{{ route('order.action', ['order_id' => $order->id, 'button_name' => 'processing']) }}"><button
                                        class="status Processing">Processing</button></a>
                                <a
                                    href="{{ route('order.action', ['order_id' => $order->id, 'button_name' => 'cancelled']) }}"><button
                                        class="status Cancelled">Cancelled</button></a>
                            </td>
                            <td>
                                <ul>
